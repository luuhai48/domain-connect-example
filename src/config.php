...
// Match `syncPubKeyDomain` in the domain-connect template file.
define('DM_KEY', 'domainconnect.userdashboard');
define('DM_DOMAIN', 'pixely.com');

// Get these info from the github repo of domain connect
...
// Redirect urls are whitelist in the file https://github.com/Domain-Connect/Templates/blob/master/userdashboard.pixely.com.arecord.json.
